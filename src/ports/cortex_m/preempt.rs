...
pub fn setup_stack(thread: &mut crate::task_manager::preemptive::Thread) {
    ...
    thread.context.s16 = 0.0;
    thread.context.s17 = 0.0;
    thread.context.s18 = 0.0;
    thread.context.s19 = 0.0;
    thread.context.s20 = 0.0;
    thread.context.s21 = 0.0;
    thread.context.s22 = 0.0;
    thread.context.s23 = 0.0;
    thread.context.s24 = 0.0;
    thread.context.s25 = 0.0;
    thread.context.s26 = 0.0;
    thread.context.s27 = 0.0;
    thread.context.s28 = 0.0;
    thread.context.s29 = 0.0;
    thread.context.s30 = 0.0;
    thread.context.s31 = 0.0;

    unsafe {
        // Stack Initialization
        *((stack_bottom - 4) as *mut u32) = 0; // FPSCR
        *((stack_bottom - 8) as *mut f32) = 0.0; // S15
        *((stack_bottom - 12) as *mut f32) = 0.0; // S14
        *((stack_bottom - 16) as *mut f32) = 0.0; // S13
        *((stack_bottom - 20) as *mut f32) = 0.0; // S12
        *((stack_bottom - 24) as *mut f32) = 0.0; // S11
        *((stack_bottom - 28) as *mut f32) = 0.0; // S10
        *((stack_bottom - 32) as *mut f32) = 0.0; // S9
        *((stack_bottom - 36) as *mut f32) = 0.0; // S8
        *((stack_bottom - 40) as *mut f32) = 0.0; // S7
        *((stack_bottom - 44) as *mut f32) = 0.0; // S6
        *((stack_bottom - 48) as *mut f32) = 0.0; // S5
        *((stack_bottom - 52) as *mut f32) = 0.0; // S4
        *((stack_bottom - 56) as *mut f32) = 0.0; // S3
        *((stack_bottom - 60) as *mut f32) = 0.0; // S2
        *((stack_bottom - 64) as *mut f32) = 0.0; // S1
        *((stack_bottom - 68) as *mut f32) = 0.0; // S0
